...
class TestBooksCollector:
    ...
    def test_add_new_book_already_added_book(collector):
        collector.add_new_book("Гарри Поттер")
        collector.add_new_book("Гарри Поттер")
        assert len(collector.get_books_genre()) == 1
        assert collector.get_book_genre("Гарри Поттер") == ""

    def test_add_new_book_name_out_of_range_short(collector):
    ...
    def test_add_new_book_various_names(collector, name, expected_count):
        collector.add_new_book(name)
        assert len(collector.get_books_genre()) == expected_count    

    def test_set_book_genre_to_existing_book(collector):
        collector.add_new_book("Гарри Поттер")
        collector.set_book_genre("Гарри Поттер", "Фантастика")
        assert collector.get_book_genre("Гарри Поттер") == "Фантастика"


    def test_set_book_genre_to_not_existing_book(collector):
    ...
    def test_set_book_genre_valid_genres(collector, genre):
        collector.add_new_book("Гарри Поттер")
    ...
    def test_set_book_genre_invalid_genres(collector, genre):
        collector.add_new_book("Гарри Поттер")
        collector.set_book_genre("Гарри Поттер", genre)
        assert collector.get_book_genre("Гарри Поттер") == ""      

    def test_get_books_with_specific_genre_by_genre(collector):
        collector.add_new_book("Гарри Поттер")
        collector.set_book_genre("Гарри Поттер", "Фантастика")
    ...
    def test_add_book_in_favorites_added_in_favorites_book(collector):
        collector.add_new_book("Гарри Поттер")
